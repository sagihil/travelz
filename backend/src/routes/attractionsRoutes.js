...
const attractionsController = require('../controllers/attractionsDbController');
...
// Create – any authenticated user (regular users included)
router.post('/', authMiddleware, attractionsController.createAttraction);
